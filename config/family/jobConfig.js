module.exports = {
    ...
    JOBS: {
        j1: { name: "Shipper", salary: 300000, type: "shipper", requirements: [], description: "Giao hàng nhanh chóng và an toàn" },
        j2: { name: "Phụ hồ", salary: 360000, type: "construction", requirements: [], description: "Xây dựng và phát triển công trình" },
        j3: { name: "Phục vụ", salary: 270000, type: "service", requirements: [], description: "Phục vụ khách hàng tận tình" },
        j4: { name: "Công nhân", salary: 480000, type: "worker", requirements: ["e1"], description: "Vận hành máy móc và sản xuất" },
        j5: { name: "Nhân viên bán hàng", salary: 420000, type: "sales", requirements: ["e1"], description: "Tư vấn và bán hàng chuyên nghiệp" },
        j6: { name: "Lễ tân khách sạn", salary: 450000, type: "service", requirements: ["e1"], description: "Tiếp đón và phục vụ khách hàng" },
        j7: { name: "Kế toán", salary: 720000, type: "accountant", requirements: ["e2"], description: "Quản lý tài chính và sổ sách" },
        j8: { name: "Lập trình viên", salary: 1200000, type: "developer", requirements: ["e3", "fe", "be"], description: "Phát triển phần mềm và ứng dụng" },
        j9: { name: "Giáo viên", salary: 900000, type: "teacher", requirements: ["e3", "eng2"], description: "Giảng dạy và đào tạo học sinh" },
        j10: { name: "Giảng viên ĐH", salary: 1800000, type: "lecturer", requirements: ["e4", "eng3"], description: "Giảng dạy và nghiên cứu đại học" },
        j11: { name: "Nghiên cứu viên", salary: 2100000, type: "researcher", requirements: ["e4", "e5", "eng3"], description: "Nghiên cứu và phát triển khoa học" },
        j12: { name: "Chuyên gia IT", salary: 3000000, type: "consultant", requirements: ["e4", "aws", "azure", "ccna"], description: "Tư vấn giải pháp công nghệ cấp cao" },
        j13: { name: "Nhà khoa học trưởng", salary: 6000000, type: "researcher", requirements: ["e5", "eng3", "research1"], description: "Lãnh đạo nhóm nghiên cứu đỉnh cao, công bố quốc tế" },
        j14: { name: "Chuyên viên thương mại", salary: 1000000, type: "sales", requirements: ["e3", "eng2"], description: "Phát triển thị trường và quan hệ thương mại quốc tế" },
        j15: { name: "Bác sĩ", salary: 1500000, type: "medical", requirements: ["e3", "hmu"], description: "Khám chữa bệnh và chăm sóc sức khỏe" },
        j16: { name: "Kỹ sư nông nghiệp", salary: 960000, type: "agriculture", requirements: ["e3", "tuaf"], description: "Phát triển và ứng dụng kỹ thuật nông nghiệp" },
        j17: { name: "Chuyên gia hải sản", salary: 1020000, type: "marine", requirements: ["e3", "ntu"], description: "Nghiên cứu và phát triển ngành hải sản" },
        j18: { name: "Nhà nghiên cứu xã hội", salary: 990000, type: "researcher", requirements: ["e3", "eng2"], description: "Nghiên cứu các vấn đề xã hội và nhân văn" },
        j19: { name: "Chuyên viên phân tích", salary: 1140000, type: "analyst", requirements: ["e3", "eng2"], description: "Phân tích dữ liệu và đưa ra giải pháp" },
        j20: { name: "Kiến trúc sư phần mềm", salary: 1680000, type: "developer", requirements: ["e4", "aws"], description: "Thiết kế và phát triển kiến trúc phần mềm" },
        j21: { name: "Giáo sư y khoa", salary: 3600000, type: "medical", requirements: ["e5", "hmu", "research1"], description: "Nghiên cứu và giảng dạy y khoa cấp cao" },
        j22: { name: "Chuyên gia kinh tế", salary: 1300000, type: "consultant", requirements: ["e4", "eng3"], description: "Tư vấn và hoạch định chính sách kinh tế" },
        j23: { name: "Việc cơ bản cho Đại Học", salary: 300000, requirements: ["e3"], description: "Việc cơ bản cho sinh viên Đại Học" },
        j24: { name: "Việc cơ bản cho Cao Đẳng", salary: 180000, requirements: ["e2"], description: "Việc cơ bản cho sinh viên Cao Đẳng" },
