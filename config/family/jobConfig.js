module.exports = {
    ...
    JOBS: {
        j1: { name: "Shipper", salary: 3000, type: "shipper", requirements: [], description: "Giao hàng nhanh chóng và an toàn" },
    j2: { name: "Phụ hồ", salary: 3600, type: "construction", requirements: [], description: "Xây dựng và phát triển công trình" },
    j3: { name: "Phục vụ", salary: 2700, type: "service", requirements: [], description: "Phục vụ khách hàng tận tình" },
    j4: { name: "Công nhân", salary: 4800, type: "worker", requirements: ["e1"], description: "Vận hành máy móc và sản xuất" },
    j5: { name: "Nhân viên bán hàng", salary: 4200, type: "sales", requirements: ["e1"], description: "Tư vấn và bán hàng chuyên nghiệp" },
    j6: { name: "Lễ tân khách sạn", salary: 4500, type: "service", requirements: ["e1"], description: "Tiếp đón và phục vụ khách hàng" },
    j7: { name: "Kế toán", salary: 7200, type: "accountant", requirements: ["ueh", "neu"], description: "Quản lý tài chính và sổ sách" },
    j8: { name: "Lập trình viên", salary: 132000, type: "developer", requirements: ["hcmut", "hust", "fe", "be"], description: "Phát triển phần mềm và ứng dụng" },
    j9: { name: "Giáo viên", salary: 90000, type: "teacher", requirements: ["hnue", "eng2"], description: "Giảng dạy và đào tạo học sinh" },
    j10: { name: "Giảng viên ĐH", salary: 180000, type: "lecturer", requirements: ["e4", "eng3"], description: "Giảng dạy và nghiên cứu đại học" },
    j11: { name: "Nghiên cứu viên", salary: 210000, type: "researcher", requirements: ["e4", "e5", "eng3"], description: "Nghiên cứu và phát triển khoa học" },
    j12: { name: "Chuyên gia IT", salary: 300000, type: "consultant", requirements: ["e4", "aws", "azure", "ccna", "hcmut"], description: "Tư vấn giải pháp công nghệ cấp cao" },
    j13: { name: "Nhà khoa học trưởng", salary: 600000, type: "researcher", requirements: ["e5", "eng3", "research1"], description: "Lãnh đạo nhóm nghiên cứu đỉnh cao, công bố quốc tế" },
    j14: { name: "Chuyên viên thương mại", salary: 1080000, type: "sales", requirements: ["ftu", "eng2"], description: "Phát triển thị trường và quan hệ thương mại quốc tế" },
    j15: { name: "Bác sĩ", salary: 1500000, type: "medical", requirements: ["hmu"], description: "Khám chữa bệnh và chăm sóc sức khỏe" },
    j16: { name: "Kỹ sư nông nghiệp", salary: 960000, type: "agriculture", requirements: ["tuaf"], description: "Phát triển và ứng dụng kỹ thuật nông nghiệp" },
    j17: { name: "Chuyên gia hải sản", salary: 1020000, type: "marine", requirements: ["ntu"], description: "Nghiên cứu và phát triển ngành hải sản" },
    j18: { name: "Nhà nghiên cứu xã hội", salary: 990000, type: "researcher", requirements: ["vnuhn", "eng2"], description: "Nghiên cứu các vấn đề xã hội và nhân văn" },
    j19: { name: "Chuyên viên phân tích", salary: 1140000, type: "analyst", requirements: ["vnuhcm", "eng2"], description: "Phân tích dữ liệu và đưa ra giải pháp" },
    j20: { name: "Kiến trúc sư phần mềm", salary: 1680000, type: "developer", requirements: ["hcmut", "hust", "aws"], description: "Thiết kế và phát triển kiến trúc phần mềm" },
    j21: { name: "Giáo sư y khoa", salary: 360000, type: "medical", requirements: ["e4", "hmu", "research1"], description: "Nghiên cứu và giảng dạy y khoa cấp cao" },
    j22: { name: "Chuyên gia kinh tế", salary: 3300000, type: "consultant", requirements: ["e4", "neu", "ueh", "eng3"], description: "Tư vấn và hoạch định chính sách kinh tế" },
    j23: { name: "Việc cơ bản cho Đại Học", salary: 30000, requirements: ["e3"], description: "Việc cơ bản cho sinh viên Đại Học" },
    j24: { name: "Việc cơ bản cho Cao Đẳng", salary: 18000, requirements: ["e2"], description: "Việc cơ bản cho sinh viên Cao Đẳng" },
    j25: { name: "JOB ADMIN TEST", salary: 6, requirements: ["e1"], description: "JOB ADMIN TEST" }
}
    };